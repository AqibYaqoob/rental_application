...
class User extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = [
        'TenantId', 'Username', 'password', 'LastPasswordUpdate', 'IsAdmin', 'LastUpdateBy', 'LastUpdateIPAddress', 'CreatedBy', 'CreatedIPAddress', 'LastLogin', 'LastLoginIPAddress', 'email', 'Roles', 'AccountStatus', 'account_type', 'interest_rate', 'name',
    ];
